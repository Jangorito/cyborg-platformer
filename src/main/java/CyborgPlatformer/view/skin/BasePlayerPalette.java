...
public final class BasePlayerPalette {
    ...
    public static final int SUIT_DARK  = PlayerSkin.hex("222A5C");
    public static final int SUIT_MID   = PlayerSkin.hex("566A89");
    public static final int SUIT_LIGHT = PlayerSkin.hex("8BABBF");

    public static final int LED       = PlayerSkin.hex("5BECF1");
}
